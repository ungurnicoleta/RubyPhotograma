...
class PhotoTagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create photo_tag" do
    assert_difference('PhotoTag.count') do
      post photo_tags_url, params: { photo_tag: { photo_id: @photo_tag.photo_id, tag_id: @photo_tag.tag_id } }
    end
  ...
  test "should update photo_tag" do
    patch photo_tag_url(@photo_tag), params: { photo_tag: { photo_id: @photo_tag.photo_id, tag_id: @photo_tag.tag_id } }
